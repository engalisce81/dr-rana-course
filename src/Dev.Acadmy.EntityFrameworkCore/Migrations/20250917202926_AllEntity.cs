    ...
    public partial class AllEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAccountTypesApp", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCollegesApp", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppMediaItemsApp",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMediaItemsApp", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppQuestionTypesApp",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuestionTypesApp", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuizesApp", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCoursesApp", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuizStudentApp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppQuizStudentApp_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppQuizStudentApp_AppQuizesApp_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppChaptersApp", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AppCourseStudentesApp",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsSubscibe = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCourseStudentesApp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppCourseStudentesApp_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuestionBanksApp", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLecturesApp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLecturesApp_AppChaptersApp_ChapterId",
                        column: x => x.ChapterId,
                        principalTable: "AppChaptersApp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuestionesApp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppQuestionesApp_AppQuestionBanksApp_QuestionBankId",
                        column: x => x.QuestionBankId,
                        principalTable: "AppQuestionBanksApp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppQuestionesApp_AppQuestionTypesApp_QuestionTypeId",
                        column: x => x.QuestionTypeId,
                        principalTable: "AppQuestionTypesApp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppQuestionesApp_AppQuizesApp_QuizId",
                        column: x => x.QuizId,
                        principalTable: "AppQuizesApp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuestionAnsweresApp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppQuestionAnsweresApp_AppQuestionesApp_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppChaptersApp_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCourseStudentesApp_CourseId",
                table: "AppCourseStudentesApp",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_AppCourseStudentesApp_UserId_CourseId",
                table: "AppCourseStudentesApp",
                columns: new[] { "UserId", "CourseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppLecturesApp_ChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppQuestionAnsweresApp_QuestionId",
                table: "AppQuestionAnsweresApp",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppQuestionesApp_QuestionBankId",
                table: "AppQuestionesApp",
                column: "QuestionBankId");

            migrationBuilder.CreateIndex(
                name: "IX_AppQuestionesApp_QuestionTypeId",
                table: "AppQuestionesApp",
                column: "QuestionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppQuestionesApp_QuizId",
                table: "AppQuestionesApp",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_AppQuizStudentApp_QuizId",
                table: "AppQuizStudentApp",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_AppQuizStudentApp_UserId_QuizId",
                table: "AppQuizStudentApp",
